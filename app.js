...
app.get("/", async (req, res) => {
  ...
  async function capture() {
    ...
    NodeWebcam.capture("faizan.jpeg", opts, (err, data) => {});
    ...
    NodeWebcam.capture("faizan.jpeg", optsBase64, (err, data) => {
  ...
  res.sendFile(`D:/FAIZAN/R Programming/guestCamera/index.html`);
